...
public class NoteTitleTest implements EncryptedValueObjectBehaviorTest {

    private static final String NULL_MESSAGE = "NoteTitle value is <null>";
    private static final String EMPTY_MESSAGE = "NoteTitle data is <empty>";
